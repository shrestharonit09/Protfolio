...
const Project = () => {
  return (
    <div className="flex flex-col gap-8 min-h-screen bg-gray-100 mt-12 py-8">
      ...
      <div className="flex justify-center">
        <div className="w-[50vw] sm:w-[42vw] md:w-[68vw] lg:w-[55vw] xl:w-[70vw] 2xl:w-[65vw]  grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-20 sm:gap-24 md:gap-8 lg:gap-8 xl:gap-12">
          {student.map((item) => (
            <Card
              title={item.title}
